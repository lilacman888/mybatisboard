...
<table border=1 width=400 align=center>
	...
	<tr>
		<td>내용</td>
		<td>${board_content} <%-- <pre>${board.board_content}</pre> --%>
		</td>
	</tr>
	<tr>
		<td>첨부파일</td>
		<td>
			<!-- 첨부파일이 있을때만 첨부파일 출력 --> <c:if test="${board.board_file != null }">
				<a
					href="<%=request.getContextPath() %>/board/file_down.jsp?file_name=${board.board_file }">
					${board.board_file} </a>
			</c:if>
		</td>
	</tr>
	<tr>
		<td colspan=2 align=center><input type="button" value="댓글"
